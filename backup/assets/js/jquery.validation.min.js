...
NUMERIC:/^\d+(?:[,\s]\d{3})*(?:\.\d+)?$/,
MIXED:/^[\w\s-]+$/,
FNAME:/^['a-zãàáäâẽèéëêìíïîõòóöôùúüûñç\s-]+$/i,
LNAME:/^['a-zãàáäâẽèéëêìíïîõòóöôùúüûñç\s-]+$/i,
NOSPACE:/^(?!\s)\S*$/,
TRIM:/^[^\s].*[^\s]$/,
...
LOGINPASSWORD:/^[a-zA-Z0-9!@#$%^&*]{6,16}$/,
OPTIONAL:/\S/,
COMPARISON:/^\s*([LV])\s*([<>]=?|==|!=)\s*([^<>=!]+?)\s*$/},_messages={"default":"$ contain error(s).",
NOTEMPTY:"Please enter $.",
...
DATE:"Please enter a valid date with format DD-MM-YYYY.",
EMAIL:"Please enter a valid email address",
PASSWORD:"Your password should contain at least six characters",
LOGINPASSWORD:"Your password is not valid.",
URL:"$ is not valid.",
EXPDATE:"Please enter expiry date of passport.",
ISSUEDATE:"Please enter issue date of passport.",
PNO:"Please enter passport number.",
NATIONALITY:"Please select citizen country.",
