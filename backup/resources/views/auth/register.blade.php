...
<div class="container">
  ...
  <div class="card-body mx-4 mt-0">
    ...
    <input type="radio" name="account_type" id="customControlValidation1"  class="custom-control-input" required>
    <label class="custom-control-label" for="customControlValidation1">I want to create lab profile</label>
  </div>
  <div class="custom-control custom-radio" style="margin-left:12px;">
    <input type="radio" name="account_type" class="custom-control-input" id="customControlValidation2" required>
