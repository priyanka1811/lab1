     ...
     <!-- Sidebar navigation -->
        <div id="slide-out" class="side-nav sn-bg-4 fixed">
            ...
            <ul class="collapsible collapsible-accordion">
                    ...
                    <li><a href="#" class="collapsible-header waves-effect arrow-r"><i class="fa fa-tachometer"></i> RFQ</a>
...
-->
       ...
       <nav class="navbar  navbar-expand-lg scrolling-navbar double-nav navbar-dark primary-color">
        ...
        <div class="float-left">
            ...
            <!-- Breadcrumb-->
            <div class="breadcrumb-dn mr-auto" style="color:#fff;">
                <p><a href="{{url('/home')}}" style="color:#fff;" >Crop Genetics & Informatics Group</a></p>
            </div>
            @endguest  
