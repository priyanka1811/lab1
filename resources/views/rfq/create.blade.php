 ...
 <!-- <h2 class="primary-heading">request</h2>-->
        <div class="card">
          ...
          <h5 class=" py-4">
            ...
            <form class="needs-validation" id="rfqform" name="rfqform" novalidate  style="color: #757575;" method="post" action="{{ route('rfq-store') }}">
            ...
            <div class="form-row">
               <div class="col-md-6">
                          <!-- Last name -->
                  <div class="">
                  <select class="mdb-select md-form" name="category_type[]" require>
                    <option value="" selected>* Choose Category Type</option>
                    <option value="1">User 1</option>
                    <option value="2">User 2</option>
                    <option value="3">User 3</option>
                </select>
                  <div class="invalid-feedback" id="category_type_0">
                     ...
                     Please enter catalouge number.
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="md-form">
                            ...
                            <div class="invalid-feedback" id="item_name_0">
        ...
        <div class="form-row">
                        ...
                        <div class="col-md-6">
                          <!-- Last name -->
                          <div class="md-form">
                            <input type="text" name="quantity[]" value="" id="qty" class="form-control">
                            <label for="qty" class=""> Qty</label>
                            <div class="invalid-feedback" id="quantity_0">
        ...
        <div class="form-row">
            ...
            <input type="checkbox" name="urgent[]" class="custom-control-input clickcheck" id="u" rel="0">
            <label class="custom-control-label" for="u">Urgent</label>
            </div>
                </div>
                
                <div class="col-md-6">
                <div class="md-form hide0" style="display:none">
                ...
                <div class="invalid-feedback" id="urgent_date_0">
...
jQuery(document).ready(function(){
  jQuery('#submit').click(function(e){
    e.preventDefault();
    jQuery(".invalid-feedback").removeAttr("style");
